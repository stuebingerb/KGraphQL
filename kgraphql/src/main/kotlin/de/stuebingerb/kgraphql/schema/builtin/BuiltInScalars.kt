...
package de.stuebingerb.kgraphql.schema.builtin
...
import de.stuebingerb.kgraphql.schema.model.ast.ValueNode.BooleanValueNode
import de.stuebingerb.kgraphql.schema.model.ast.ValueNode.DoubleValueNode
...
enum class BuiltInScalars(val typeDef: TypeDef.Scalar<*>) {
    ...
    ID(
        TypeDef.Scalar(
            de.stuebingerb.kgraphql.schema.scalar.ID::class.defaultKQLTypeName(),
            de.stuebingerb.kgraphql.schema.scalar.ID::class,
            ID_COERCION,
            ID_DESCRIPTION
        )
    )
