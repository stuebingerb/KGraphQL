...
import de.stuebingerb.kgraphql.schema.model.ast.ValueNode.ObjectValueNode
import de.stuebingerb.kgraphql.schema.scalar.deserializeScalar
        ...
        return when {
            ...
            value is ObjectValueNode -> {
                ...
                if (inputType.isOneOf == true) {
                    ...
                    if (value == null) {
                        throw InvalidInputValueException(
                            "Value for member field '${parameter?.name}' must be non-null",
                            executionNode
                        )
                    }
                }
