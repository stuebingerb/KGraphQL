---
title: Ktor
description: A guide on how to set up KGraphQL with Ktor.
---
...
You first need to add the KGraphQL-ktor dependency to your dependencies.

```kotlin title="Kotlin Gradle Script"
...
| schema       | This is where you are defining your schema. Please refer to [KGraphQL References](/reference/configuration/) for further documentation on this.                               | ***required*** |
...
A schema defined in KGraphQL like the following
...
will result in the following schema in SDL
