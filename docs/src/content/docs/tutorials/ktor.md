...
```kotlin title="src/Application.kt"
...
Now we have a fully functional GraphQL Server, and we can start up our server by pressing the green play icon beside the
`main` function.
...
A great place to learn more is following the [Star Wars tutorial](/tutorials/star-wars/). Everything mentioned in this tutorial
