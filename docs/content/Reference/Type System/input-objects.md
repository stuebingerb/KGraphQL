...
Input Objects configured with `isOneOf = true` in the `inputType` DSL (or declared with the `@oneOf` directive in SDL)
result in a [OneOf Input Object](https://spec.graphql.org/September2025/#sec-OneOf-Input-Objects).
