...
class StitchedSchemaCompilation(
    ...
    val definition: StitchedSchemaDefinition
) {
    ...
    suspend fun perform(): DefaultSchema {
        ...
        definition.links.groupBy { it.typeName }.forEach { (typeName, links) ->
            ...
            originalType.proxied = when (proxiedOriginalType) {
                is Type.RemoteObject -> proxiedOriginalType.withStitchedFields(linkedFields)
                is Type.Object<*> -> proxiedOriginalType.withStitchedFields(linkedFields)
