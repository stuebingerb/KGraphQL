...
import de.stuebingerb.kgraphql.GraphqlRequest
import de.stuebingerb.kgraphql.schema.dsl.SchemaBuilder
import de.stuebingerb.kgraphql.schema.execution.Execution
import de.stuebingerb.kgraphql.stitched.StitchedGraphQL
import de.stuebingerb.kgraphql.stitched.getRemoteSchema
import de.stuebingerb.kgraphql.stitched.schema.structure.StitchedSchemaTest.Face
import de.stuebingerb.kgraphql.stitched.schema.structure.StitchedSchemaTest.Inter
import de.stuebingerb.kgraphql.stitched.schema.structure.StitchedSchemaTest.InterInter
...
class StitchedSchemaExecutionTest {
    ...
    fun `error responses from remote execution should be propagated correctly`() = testApplication {
        ...
        fun SchemaBuilder.remoteSchema() = run {
            ...
            query("failRemoteObject") {
                resolver<List<RemoteType?>, String> { localName: String ->
                    listOf(
        ...
        client.post("local") {
            ...
            {"errors":[{"message":"don't call me local!","locations":[{"line":1,"column":3}],"path":["failLocal"],"extensions":{"type":"INTERNAL_SERVER_ERROR","detail":{"localErrorKey":"localErrorValue"}}}],"data":{"failLocal":null}}
        """.trimIndent()
    ...
    fun `errors from remote execution should be propagated correctly`() = testApplication {
        ...
        client.post("local") {
            ...
            {"errors":[{"message":"Connection timed out","locations":[{"line":1,"column":3}],"path":["remoteString"],"extensions":{"remoteUrl":"remote","remoteOperation":"remoteString","type":"INTERNAL_SERVER_ERROR"}}],"data":{"remoteString":null}}
        """.trimIndent()
        ...
        client.post("local") {
            ...
            {"errors":[{"message":"Connection timed out","locations":[{"line":1,"column":21}],"path":["localTypes",0,"stitchedProperty"],"extensions":{"remoteUrl":"remote","remoteOperation":"remoteString","type":"INTERNAL_SERVER_ERROR"}}],"data":{"localTypes":[{"name":"local1","stitchedProperty":null}]}}
        """.trimIndent()
    }
